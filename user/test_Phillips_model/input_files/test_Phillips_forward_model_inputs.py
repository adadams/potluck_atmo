...
altitudes_in_cm: xr.DataArray = xr.DataArray(
    calculate_altitude_profile(
        user_vertical_inputs.log_pressures_by_level.to_numpy(),
        user_vertical_inputs.temperatures_by_level.to_numpy(),
