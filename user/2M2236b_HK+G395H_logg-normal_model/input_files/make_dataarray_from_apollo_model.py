...
apollo_model_directory: Path = (
    current_directory / "reference_inputs" / "HK+G395H" / "HK+G395H_logg-normal"
)

apollo_model_filepath: Path = (
    apollo_model_directory
    / "2M2236.Piette.HK+G395H.cloud-free.2024-03-14.logg-normal.binned.dat"
)
...
data.to_netcdf(current_directory / "2M2236b_HK+G395H_logg-normal_apollo_model.nc")
