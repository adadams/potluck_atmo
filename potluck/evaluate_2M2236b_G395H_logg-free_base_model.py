...
if __name__ == "__main__":
    apollo_model_filepath: Path = (
        input_file_directory / "2M2236b_G395H_logg-free_apollo_model.nc"
    )
    ...
    model_spectrum_rescaled: xr.DataArray = xr.where(
        test_model_spectrum.wavelength < 4.1,
        test_model_spectrum * 0.8663427867,
        test_model_spectrum * 1.050878524,
    )
    ...
    figure.savefig(
        output_file_directory / "2M2236b_G395H_logg-free_model_comparison.pdf",
        bbox_inches="tight",
    )
